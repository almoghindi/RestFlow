...
namespace RestFlow.DAL.Migrations
{
    ...
    [Migration("20240827183009_UpdateSchemas11")]
    partial class UpdateSchemas11
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RestFlow.DAL.Entities.Restaurant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("RestFlow.DAL.Entities.Category", b =>
                {
                    b.HasOne("RestFlow.DAL.Entities.Restaurant", "Restaurant")
                        .WithMany()
